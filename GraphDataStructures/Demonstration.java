...
public class Demonstration {
  ...
  public static void main(String[] args) {
    ...
    graph2.printGraph();
    System.out
        .println("Remove vertex (node) with name TRAIN (which is not in graph2) from graph2 (should be unsuccessful)");
    ...
    System.out
        .println("Demonstration for addWeightedEdge(String from, String to, int weight) with printWeightedGraph():");
